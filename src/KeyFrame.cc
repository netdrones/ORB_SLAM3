...
KeyFrame::KeyFrame():
        ...
        mbf(0), mb(0), mThDepth(0), N(0), mvKeys(static_cast<vector<cv::KeyPoint> >(0)), mvKeysUn(static_cast<vector<cv::KeyPoint> >(0)),
        mvuRight(static_cast<vector<float> >(0)), mvDepth(static_cast<vector<float> >(0)), mnScaleLevels(0), mfScaleFactor(0),
        mfLogScaleFactor(0), mvScaleFactors(0), mvLevelSigma2(0), mvInvLevelSigma2(0), mnMinX(0), mnMinY(0), mnMaxX(0),
        mnMaxY(0), mPrevKF(static_cast<KeyFrame*>(nullptr)), mNextKF(static_cast<KeyFrame*>(NULL)), mbFirstConnection(true), mpParent(nullptr), mbNotErase(false),
...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mnMaxY(F.mnMaxY), mK_(F.mK_), mPrevKF(nullptr), mNextKF(NULL), mpImuPreintegrated(F.mpImuPreintegrated),
